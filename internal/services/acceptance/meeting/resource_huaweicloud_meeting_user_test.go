...
func TestAccUser_basic(t *testing.T) {
	var (
		user         users.User
		resourceName = "hcso_meeting_user.test"
...
`, acceptance.HCSO_MEETING_APP_ID, acceptance.HCSO_MEETING_APP_KEY, acceptance.HCSO_MEETING_USER_ID, account)
}
...
`, acceptance.HCSO_MEETING_APP_ID, acceptance.HCSO_MEETING_APP_KEY, acceptance.HCSO_MEETING_USER_ID, account, thirdAccount)
}
...
`, acceptance.HCSO_MEETING_APP_ID, acceptance.HCSO_MEETING_APP_KEY)
}
