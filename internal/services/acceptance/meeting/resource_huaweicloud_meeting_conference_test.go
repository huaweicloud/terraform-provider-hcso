...
func TestAccConference_basic(t *testing.T) {
	var (
		...
		resourceName = "hcso_meeting_conference.test"
		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					resource.TestCheckResourceAttr(resourceName, "app_id", acceptance.HCSO_MEETING_APP_ID),
					resource.TestCheckResourceAttr(resourceName, "app_key", acceptance.HCSO_MEETING_APP_KEY),
					resource.TestCheckResourceAttr(resourceName, "user_id", acceptance.HCSO_MEETING_USER_ID),
					resource.TestCheckResourceAttr(resourceName, "topic", baiscName),
					resource.TestCheckResourceAttr(resourceName, "meeting_room_id", acceptance.HCSO_MEETING_ROOM_ID),
					...
					resource.TestCheckResourceAttr(resourceName, "participant.0.email", acceptance.HCSO_CHAIR_EMAIL),
					resource.TestCheckResourceAttr(resourceName, "participant.1.role", "0"),
					resource.TestCheckResourceAttr(resourceName, "participant.1.email", acceptance.HCSO_GUEST_EMAIL),
		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					rc.CheckResourceExists(),
					resource.TestCheckResourceAttr(resourceName, "account_name", acceptance.HCSO_MEETING_ACCOUNT_NAME),
					resource.TestCheckResourceAttr(resourceName, "account_password", acceptance.HCSO_MEETING_ACCOUNT_PASSWORD),
					resource.TestCheckResourceAttr(resourceName, "topic", rName),
					resource.TestCheckResourceAttr(resourceName, "meeting_room_id", acceptance.HCSO_MEETING_ROOM_ID),
					resource.TestCheckResourceAttr(resourceName, "duration", "15"),
					resource.TestCheckResourceAttr(resourceName, "media_types.#", "3"),
...
func testAccConferenceImportStateIdFunc() resource.ImportStateIdFunc {
	return func(s *terraform.State) (string, error) {
		...
		for _, rs := range s.RootModule().Resources {
			if rs.Type == "hcso_meeting_conference" {
...
`, acceptance.HCSO_MEETING_APP_ID, acceptance.HCSO_MEETING_APP_KEY, acceptance.HCSO_MEETING_USER_ID,
		acceptance.HCSO_MEETING_ROOM_ID, acceptance.HCSO_CHAIR_EMAIL, acceptance.HCSO_GUEST_EMAIL, rName, startTime)
}
...
`, acceptance.HCSO_MEETING_APP_ID, acceptance.HCSO_MEETING_APP_KEY, acceptance.HCSO_MEETING_USER_ID,
		acceptance.HCSO_MEETING_ROOM_ID, acceptance.HCSO_CHAIR_EMAIL, rName, startTime)
}
...
`, acceptance.HCSO_MEETING_APP_ID, acceptance.HCSO_MEETING_APP_KEY, acceptance.HCSO_MEETING_USER_ID,
		acceptance.HCSO_MEETING_ROOM_ID, acceptance.HCSO_CHAIR_EMAIL, acceptance.HCSO_GUEST_EMAIL, rName, startDate, endDate)
}
...
`, acceptance.HCSO_MEETING_ACCOUNT_NAME, acceptance.HCSO_MEETING_ACCOUNT_PASSWORD, acceptance.HCSO_MEETING_ROOM_ID,
		acceptance.HCSO_CHAIR_EMAIL, acceptance.HCSO_GUEST_EMAIL, rName)
}
