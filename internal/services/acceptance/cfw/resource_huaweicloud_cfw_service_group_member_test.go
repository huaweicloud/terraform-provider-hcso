...
func TestAccServiceGroupMember_basic(t *testing.T) {
	...
	rName := "hcso_cfw_service_group_member.test"
		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					resource.TestCheckResourceAttrPair(rName, "group_id", "hcso_cfw_service_group.test", "id"),
...
resource "hcso_cfw_service_group_member" "test" {
  group_id    = hcso_cfw_service_group.test.id
  protocol    = 6
  source_port = "80"
  dest_port   = "22"
}
