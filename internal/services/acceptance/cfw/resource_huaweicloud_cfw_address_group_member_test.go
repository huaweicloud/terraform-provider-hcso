...
func TestAccAddressGroupMember_basic(t *testing.T) {
	...
	rName := "hcso_cfw_address_group_member.test"
		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					resource.TestCheckResourceAttrPair(rName, "group_id", "hcso_cfw_address_group.test", "id"),
...
resource "hcso_cfw_address_group_member" "test" {
  group_id = hcso_cfw_address_group.test.id
  address  = "192.168.0.1"
}
