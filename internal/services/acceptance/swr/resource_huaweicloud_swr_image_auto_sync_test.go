...
func TestAccSwrImageAutoSync_basic(t *testing.T) {
	...
	rName := "hcso_swr_image_auto_sync.test"
		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					resource.TestCheckResourceAttr(rName, "target_region",
						acceptance.HCSO_SWR_TARGET_REGION),
					resource.TestCheckResourceAttr(rName, "target_organization",
						acceptance.HCSO_SWR_TARGET_ORGANIZATION),
...
`, testAccSWRRepository_basic(name), acceptance.HCSO_SWR_TARGET_REGION, acceptance.HCSO_SWR_TARGET_ORGANIZATION)
}
