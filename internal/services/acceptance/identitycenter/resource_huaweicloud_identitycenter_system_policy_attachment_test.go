...
func TestAccSystemPolicyAttachment_basic(t *testing.T) {
	...
	rName := "hcso_identitycenter_system_policy_attachment.test"
...
data "hcso_identity_role" "policy1" {
  display_name = "CCE Administrator"
}

data "hcso_identity_role" "policy2" {
  display_name = "SFS FullAccess"
}

data "hcso_identity_role" "policy3" {
...
resource "hcso_identitycenter_system_policy_attachment" "test" {
  ...
  policy_ids = [
    data.hcso_identity_role.policy1.id,
    data.hcso_identity_role.policy2.id,
  ]
}
...
resource "hcso_identitycenter_system_policy_attachment" "test" {
  ...
  policy_ids = [
    data.hcso_identity_role.policy2.id,
    data.hcso_identity_role.policy3.id,
  ]
}
`, testPermissionSet_basic(name))
}
