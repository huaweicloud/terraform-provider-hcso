...
func TestAccGroupMembership_basic(t *testing.T) {
	...
	rName := "hcso_identitycenter_group_membership.test"
		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					resource.TestCheckResourceAttrPair(rName, "identity_store_id",
						"data.hcso_identitycenter_instance.test", "identity_store_id"),
					resource.TestCheckResourceAttrPair(rName, "group_id",
						"hcso_identitycenter_group.test", "id"),
...
resource "hcso_identitycenter_group_membership" "test" {
  identity_store_id = data.hcso_identitycenter_instance.test.identity_store_id
  group_id          = hcso_identitycenter_group.test.id
  member_id         = hcso_identitycenter_user.test.id
}
