		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					testAccCheckGeminiDBInstancesDataSourceID("data.hcso_gaussdb_cassandra_instances.test"),
					resource.TestCheckResourceAttr("data.hcso_gaussdb_cassandra_instances.test", "instances.#", "1"),
				),
			},
		},
	})
...
data "hcso_gaussdb_cassandra_instances" "test" {
