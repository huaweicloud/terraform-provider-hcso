		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					testAccCheckEndpointGroupV2Exists(
						"hcso_vpnaas_endpoint_group_v2.group_1", &group),
					resource.TestCheckResourceAttrPtr("hcso_vpnaas_endpoint_group_v2.group_1", "name", &group.Name),
					resource.TestCheckResourceAttrPtr("hcso_vpnaas_endpoint_group_v2.group_1", "type", &group.Type),
				),
			},
			{
