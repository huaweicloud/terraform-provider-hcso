		...
		Steps: []resource.TestStep{
			...
			},
			{
				...
				Check: resource.ComposeTestCheckFunc(
					testAccCheckNetworkingSubnetV2DataSourceID("data.hcso_networking_subnet_v2.subnet_1"),
					testAccCheckNetworkingSubnetV2DataSourceGoodNetwork("data.hcso_networking_subnet_v2.subnet_1", "hcso_networking_network_v2.network_1"),
					resource.TestCheckResourceAttr(
						"data.hcso_networking_subnet_v2.subnet_1", "name", "subnet_1"),
				),
			},
		},
	})
		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					testAccCheckNetworkingSubnetV2DataSourceID("data.hcso_networking_subnet_v2.subnet_1"),
					testAccCheckNetworkingSubnetV2DataSourceGoodNetwork("data.hcso_networking_subnet_v2.subnet_1", "hcso_networking_network_v2.network_1"),
					testAccCheckNetworkingPortV2ID("hcso_networking_port_v2.port_1"),
				),
			},
		},
	})
...
data "hcso_networking_subnet_v2" "subnet_1" {
	name = "${hcso_networking_subnet_v2.subnet_1.name}"
}
...
data "hcso_networking_subnet_v2" "subnet_1" {
  gateway_ip = "${hcso_networking_subnet_v2.subnet_1.gateway_ip}"
}
`, testAccHuaweiCloudNetworkingSubnetV2DataSource_subnet)
...
resource "hcso_networking_port_v2" "port_1" {
  name               = "test_port"
  network_id         = "${data.hcso_networking_subnet_v2.subnet_1.network_id}"
  admin_state_up  = "true"
}
