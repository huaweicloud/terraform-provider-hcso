		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					testAccCheckFWRuleV2Exists("hcso_fw_rule_v2.rule_1", rule1),
				),
			},
			{
				Config: testAccFWRuleV2_basic_2,
				Check: resource.ComposeTestCheckFunc(
					testAccCheckFWRuleV2Exists("hcso_fw_rule_v2.rule_1", rule2),
				),
			},
			{
				ResourceName:      "hcso_fw_rule_v2.rule_1",
				ImportState:       true,
			...
			},
			{
				...
				Check: resource.ComposeTestCheckFunc(
					testAccCheckFWRuleV2Exists("hcso_fw_rule_v2.rule_1", rule3),
				),
			},
		},
	})
		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					testAccCheckFWRuleV2Exists("hcso_fw_rule_v2.rule_1", rule),
				),
			},
		},
	})
