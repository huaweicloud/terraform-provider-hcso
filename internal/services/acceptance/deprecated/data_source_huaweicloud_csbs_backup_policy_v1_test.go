		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					testAccCheckCSBSBackupPolicyV1DataSourceID("data.hcso_csbs_backup_policy_v1.csbs_policy"),
					resource.TestCheckResourceAttr("data.hcso_csbs_backup_policy_v1.csbs_policy", "name", "backup-policy"),
					resource.TestCheckResourceAttr("data.hcso_csbs_backup_policy_v1.csbs_policy", "status", "suspended"),
				),
			},
		},
	})
...
resource "hcso_csbs_backup_policy_v1" "backup_policy_v1" {
	name            = "backup-policy"
  	resource {
...
data "hcso_csbs_backup_policy_v1" "csbs_policy" {  
  id = "${hcso_csbs_backup_policy_v1.backup_policy_v1.id}"
}
