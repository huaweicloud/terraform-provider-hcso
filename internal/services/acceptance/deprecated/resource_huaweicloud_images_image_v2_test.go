		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					testAccCheckImagesImageV2Exists("hcso_images_image_v2.image_1", &image),
					resource.TestCheckResourceAttr(
						"hcso_images_image_v2.image_1", "name", "Rancher TerraformAccTest"),
					resource.TestCheckResourceAttr(
						"hcso_images_image_v2.image_1", "container_format", "bare"),
					/*resource.TestCheckResourceAttr(
					"hcso_images_image_v2.image_1", "disk_format", "qcow2"),*/
					resource.TestCheckResourceAttr(
						"hcso_images_image_v2.image_1", "schema", "/v2/schemas/image"),
				),
			},
			{
				ResourceName:      "hcso_images_image_v2.image_1",
				ImportState:       true,
		...
		Steps: []resource.TestStep{
			...
			},
			{
				...
				Check: resource.ComposeTestCheckFunc(
					testAccCheckImagesImageV2Exists("hcso_images_image_v2.image_1", &image),
					resource.TestCheckResourceAttr(
						"hcso_images_image_v2.image_1", "name", "TerraformAccTest Rancher"),
				),
			},
		},
	})
		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					testAccCheckImagesImageV2Exists("hcso_images_image_v2.image_1", &image),
					testAccCheckImagesImageV2HasTag("hcso_images_image_v2.image_1", "foo"),
					testAccCheckImagesImageV2HasTag("hcso_images_image_v2.image_1", "bar"),
					testAccCheckImagesImageV2TagCount("hcso_images_image_v2.image_1", 2),
				),
			},
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					testAccCheckImagesImageV2HasTag("hcso_images_image_v2.image_1", "foo"),
					testAccCheckImagesImageV2HasTag("hcso_images_image_v2.image_1", "bar"),
					testAccCheckImagesImageV2HasTag("hcso_images_image_v2.image_1", "baz"),
					testAccCheckImagesImageV2TagCount("hcso_images_image_v2.image_1", 3),
				),
			},
			{
		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					testAccCheckImagesImageV2Exists("hcso_images_image_v2.image_1", &image),
					resource.TestCheckResourceAttr(
						"hcso_images_image_v2.image_1", "visibility", "private"),
				),
			},
		},
	})
...
func testAccCheckImagesImageV2Destroy(s *terraform.State) error {
	...
	imageClient, err := config.ImageV2Client(acceptance.HCSO_REGION_NAME)
	if err != nil {
		return fmtp.Errorf("Error creating HuaweiCloud Image: %s", err)
	}

	for _, rs := range s.RootModule().Resources {
		if rs.Type != "hcso_images_image_v2" {
			continue
		}
...
var testAccImagesImageV2_basic = `
  resource "hcso_images_image_v2" "image_1" {
