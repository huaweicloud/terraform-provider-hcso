...
func TestAccSignature_basic(t *testing.T) {
	var (
		...
		rName1 = "hcso_apig_signature.with_key"
		rName2 = "hcso_apig_signature.without_key"
...
resource "hcso_apig_signature" "with_key" {
...
resource "hcso_apig_signature" "without_key" {
  instance_id = hcso_apig_instance.test.id
