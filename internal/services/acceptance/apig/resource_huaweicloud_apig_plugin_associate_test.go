...
func TestAccPluginAssociate_basic(t *testing.T) {
	var (
		...
		rName1 = "hcso_apig_plugin_associate.cors_bind"
		rName2 = "hcso_apig_plugin_associate.http_resp_bind"
		rName3 = "hcso_apig_plugin_associate.rate_limit_bind"
		rName4 = "hcso_apig_plugin_associate.kafka_log_bind"
		rName5 = "hcso_apig_plugin_associate.breaker_bind"
		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					resource.TestCheckResourceAttrPair(rName1, "plugin_id",
						"hcso_apig_plugin.cors", "id"),
					resource.TestCheckResourceAttrPair(rName1, "env_id",
						"hcso_apig_environment.test.0", "id"),
					...
					resource.TestCheckResourceAttrPair(rName3, "plugin_id",
						"hcso_apig_plugin.rate_limit", "id"),
			...
			},
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					resource.TestCheckResourceAttrPair(rName1, "plugin_id",
						"hcso_apig_plugin.cors", "id"),
					resource.TestCheckResourceAttrPair(rName1, "env_id",
						"hcso_apig_environment.test.1", "id"),
					resource.TestCheckResourceAttrPair(rName1, "api_ids.0",
						"hcso_apig_api.test", "id"),
					rc2.CheckResourceExists(),
					resource.TestCheckResourceAttrPair(rName2, "instance_id",
...
locals {
  query_results     = data.hcso_dms_kafka_flavors.test
  flavor            = data.hcso_dms_kafka_flavors.test.flavors[0]
  connect_addresses = split(",", hcso_dms_kafka_instance.test.connect_address)
  plugin_ids = [
    hcso_apig_plugin.cors.id,
    hcso_apig_plugin.http_resp.id,
    hcso_apig_plugin.rate_limit.id,
...
resource "hcso_dms_kafka_topic" "test" {
...
resource "hcso_apig_plugin" "cors" {
  instance_id = hcso_apig_instance.test.id
  name        = "%[2]s_cors"
  type        = "cors"
  content     = jsonencode(
...
resource "hcso_apig_plugin" "http_resp" {
  instance_id = hcso_apig_instance.test.id
  name        = "%[2]s_http_resp"
...
resource "hcso_apig_plugin" "rate_limit" {
  instance_id = hcso_apig_instance.test.id
  name        = "%[2]s_rate_limit"
  type        = "rate_limit"
  content     = jsonencode(
...
resource "hcso_apig_plugin" "kafka_log" {
  instance_id = hcso_apig_instance.test.id
  name        = "%[2]s_kafka_log"
  type        = "kafka_log"
  content     = jsonencode(
    {
      "broker_list": [for v in local.connect_addresses: format("%%s:%%d", v, hcso_dms_kafka_instance.test.port)],
      "topic": "${hcso_dms_kafka_topic.test.name}",
      "key": "",
      "max_retry_count": 0,
      "retry_backoff": 1,
      "sasl_config": {
...
resource "hcso_apig_plugin" "breaker" {
  instance_id = hcso_apig_instance.test.id
  name        = "%[2]s_breaker"
  type        = "breaker"
  content     = jsonencode(
...
resource "hcso_apig_plugin_associate" "cors_bind" {
  instance_id = hcso_apig_instance.test.id
  plugin_id   = local.plugin_ids[0]
  env_id      = hcso_apig_environment.test[0].id
  api_ids     = [hcso_apig_api.test.id]
}

resource "hcso_apig_plugin_associate" "http_resp_bind" {
  instance_id = hcso_apig_instance.test.id
...
resource "hcso_apig_plugin_associate" "rate_limit_bind" {
  instance_id = hcso_apig_instance.test.id
...
resource "hcso_apig_plugin_associate" "kafka_log_bind" {
  instance_id = hcso_apig_instance.test.id
...
resource "hcso_apig_plugin_associate" "breaker_bind" {
  instance_id = hcso_apig_instance.test.id
...
resource "hcso_apig_plugin_associate" "cors_bind" {
  instance_id = hcso_apig_instance.test.id
  plugin_id   = local.plugin_ids[0]
  env_id      = hcso_apig_environment.test[1].id
  api_ids     = [hcso_apig_api.test.id]
}
