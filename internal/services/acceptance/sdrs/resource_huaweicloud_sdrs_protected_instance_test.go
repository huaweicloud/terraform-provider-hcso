...
func TestAccProtectedInstance_basic(t *testing.T) {
	...
	rName := "hcso_sdrs_protected_instance.test"
		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					resource.TestCheckResourceAttrPair(rName, "group_id", "hcso_sdrs_protection_group.test", "id"),
					resource.TestCheckResourceAttrPair(rName, "server_id", "hcso_compute_instance.test", "id"),
					resource.TestCheckResourceAttrPair(rName, "primary_subnet_id", "hcso_vpc_subnet.test", "id"),
				),
			},
			{
...
resource "hcso_sdrs_protected_instance" "test" {
  ...
  primary_subnet_id    = hcso_vpc_subnet.test.id
