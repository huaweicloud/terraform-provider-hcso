...
func TestAccDataSourceLBCertificateV2_basic(t *testing.T) {
	...
	dataSourceName := "data.hcso_lb_certificate.cert_1"
...
func testAccLBCertificateSourceV2_conf(name string) string {
	return fmt.Sprintf(`
data "hcso_lb_certificate" "cert_1" {
  name = hcso_elb_certificate.certificate_1.name

  depends_on = [hcso_elb_certificate.certificate_1]
}
