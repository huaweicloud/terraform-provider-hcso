...
func TestAccLBV2Monitor_basic(t *testing.T) {
	...
	resourceName := "hcso_lb_monitor.monitor_1"
...
func TestAccLBV2Monitor_udp(t *testing.T) {
	var monitor monitors.Monitor
	rName := acceptance.RandomAccResourceNameWithDash()
	resourceName := "hcso_lb_monitor.monitor_udp"
...
func TestAccLBV2Monitor_http(t *testing.T) {
	var monitor monitors.Monitor
	rName := acceptance.RandomAccResourceNameWithDash()
	resourceName := "hcso_lb_monitor.monitor_http"
...
resource "hcso_lb_monitor" "monitor_1" {
