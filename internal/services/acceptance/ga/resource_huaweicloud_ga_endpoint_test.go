		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					resource.TestCheckResourceAttrPair(rName, "endpoint_group_id", "hcso_ga_endpoint_group.test", "id"),
					resource.TestCheckResourceAttrPair(rName, "resource_id", "hcso_vpc_eip.test", "id"),
					resource.TestCheckResourceAttrPair(rName, "ip_address", "hcso_vpc_eip.test", "address"),
...
resource "hcso_ga_endpoint" "test" {
  endpoint_group_id = hcso_ga_endpoint_group.test.id
  resource_id       = hcso_vpc_eip.test.id
