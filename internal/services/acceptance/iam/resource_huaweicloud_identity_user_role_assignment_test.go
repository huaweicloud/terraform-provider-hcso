...
func TestAccIdentityUserRoleAssignment_basic(t *testing.T) {
	...
	resourceName := "hcso_identity_user_role_assignment.test"
...
`, testAccIdentityUserRoleAssignment_base(rName), acceptance.HCSO_ENTERPRISE_PROJECT_ID_TEST)
}
