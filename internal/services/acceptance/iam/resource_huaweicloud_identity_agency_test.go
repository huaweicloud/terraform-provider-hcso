...
func TestAccIdentityAgency_basic(t *testing.T) {
	...
	resourceName := "hcso_identity_agency.test"
		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					resource.TestCheckResourceAttr(resourceName, "delegated_domain_name", acceptance.HCSO_DOMAIN_NAME),
...
`, rName, duration, acceptance.HCSO_DOMAIN_NAME, acceptance.HCSO_REGION_NAME)
}
