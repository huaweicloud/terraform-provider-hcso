...
func TestAccDataSourceWafDedicatedInstances_basic(t *testing.T) {
	...
	resourceName1 := "data.hcso_waf_dedicated_instances.instance_1"
	resourceName2 := "data.hcso_waf_dedicated_instances.instance_2"
...
func TestAccDataSourceWafDedicatedInstances_withEpsId(t *testing.T) {
	name := acceptance.RandomAccResourceName()
	resourceName := "data.hcso_waf_dedicated_instances.instance_1"
	...
	resource.ParallelTest(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			{
				Config: testAccWafDedicatedInstances_epsId(name, acceptance.HCSO_ENTERPRISE_PROJECT_ID_TEST),
				Check: resource.ComposeTestCheckFunc(
					dc.CheckResourceExists(),
...
data "hcso_waf_dedicated_instances" "instance_1" {
  name = hcso_waf_dedicated_instance.instance_1.name
...
data "hcso_waf_dedicated_instances" "instance_2" {
  id   = hcso_waf_dedicated_instance.instance_1.id
  name = hcso_waf_dedicated_instance.instance_1.name
