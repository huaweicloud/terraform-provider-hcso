...
func getCloudInstanceFunc(conf *config.Config, state *terraform.ResourceState) (interface{}, error) {
	client, err := conf.WafV1Client(acceptance.HCSO_REGION_NAME)
	if err != nil {
...
func TestAccCloudInstance_prepaid_basic(t *testing.T) {
	...
	rName := "hcso_waf_cloud_instance.test"
...
func TestAccCloudInstance_prepaid_withEpsID(t *testing.T) {
	...
	resource.ParallelTest(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			{
				Config: testAccCloudInstance_basic_withEpsID(acceptance.HCSO_ENTERPRISE_PROJECT_ID_TEST),
				Check: resource.ComposeTestCheckFunc(
					rc.CheckResourceExists(),
			...
			{
				Config: testAccCloudInstance_update_withEpsID(acceptance.HCSO_ENTERPRISE_PROJECT_ID_TEST),
				Check: resource.ComposeTestCheckFunc(
					rc.CheckResourceExists(),
					resource.TestCheckResourceAttr(rName, "enterprise_project_id",
						acceptance.HCSO_ENTERPRISE_PROJECT_ID_TEST),
...
func TestAccCloudInstance_postpaid_withEpsID(t *testing.T) {
	...
	resource.ParallelTest(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			{
				Config: testAccCloudInstance_postpaid_withEpsID(acceptance.HCSO_ENTERPRISE_PROJECT_ID_TEST),
				Check: resource.ComposeTestCheckFunc(
					rc.CheckResourceExists(),
					resource.TestCheckResourceAttr(rName, "enterprise_project_id",
						acceptance.HCSO_ENTERPRISE_PROJECT_ID_TEST),
