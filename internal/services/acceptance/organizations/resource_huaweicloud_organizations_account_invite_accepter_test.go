...
func TestAccAccountInviteAccepter_basic(t *testing.T) {
	...
	rName := "hcso_organizations_account_invite_accepter.test"
		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					resource.TestCheckResourceAttr(rName, "invitation_id", acceptance.HCSO_ORGANIZATIONS_INVITATION_ID),
...
`, acceptance.HCSO_ORGANIZATIONS_INVITATION_ID)
}
