...
func TestAccDDSV3Instance_basic(t *testing.T) {
	...
	resourceName := "hcso_dds_instance.instance"
...
%[1]s
data "hcso_availability_zones" "test" {}
resource "hcso_dds_parameter_template" "mongos" {
  name         = "%[2]s_mongos"
...
resource "hcso_dds_parameter_template" "shard" {
  name         = "%[2]s_shard"
  description  = "test description"
  node_type    = "shard"
  node_version = "3.4"
...
resource "hcso_dds_parameter_template" "config" {
  name         = "%[2]s_config"
  description  = "test description"
  node_type    = "config"
  node_version = "3.4"
...
resource "hcso_dds_instance" "instance" {
  ...
  configuration {
    type = "mongos"
    id   = hcso_dds_parameter_template.mongos.id
  }
  configuration {
    type = "shard"
    id   = hcso_dds_parameter_template.shard.id
  }
  configuration {
    type = "config"
    id   = hcso_dds_parameter_template.config.id
  }
  flavor {
    type      = "mongos"
    num       = 2
...
%[1]s
data "hcso_availability_zones" "test" {}
resource "hcso_dds_parameter_template" "replica" {
  name         = "%[2]s_replica"
  description  = "test description"
  node_type    = "replica"
  node_version = "3.4"
...
resource "hcso_dds_instance" "instance" {
  ...
  configuration {
    type = "replica"
    id   = hcso_dds_parameter_template.replica.id
  }
  flavor {
    type      = "replica"
    storage   = "ULTRAHIGH"
...
%[1]s
data "hcso_availability_zones" "test" {}
resource "hcso_dds_parameter_template" "single" {
  name         = "%[2]s_single"
  description  = "test description"
  node_type    = "single"
  node_version = "3.4"
...
resource "hcso_dds_instance" "instance" {
  ...
  configuration {
    type = "single"
    id   = hcso_dds_parameter_template.single.id
  }
  flavor {
    type      = "single"
    num       = 1
