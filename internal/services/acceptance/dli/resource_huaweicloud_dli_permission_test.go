...
func TestAccResourceDliAuth_basic(t *testing.T) {
	...
	resourceName := "hcso_dli_permission.test"
	...
	resource.ParallelTest(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			{
				Config: testAccDliAuthResource_basic(name, acceptance.HCSO_PROJECT_ID, "SELECT"),
			...
			{
				Config: testAccDliAuthResource_basic(name, acceptance.HCSO_PROJECT_ID, "CREATE_TABLE"),
				Check: resource.ComposeTestCheckFunc(
					rc.CheckResourceExists(),
					resource.TestCheckResourceAttr(resourceName, "user_name", name),
					resource.TestCheckResourceAttr(resourceName, "object", fmt.Sprintf("databases.%s", name)),
...
resource "hcso_dli_permission" "test" {
  user_name  = hcso_identity_user.test.name
  object     = "databases.${hcso_dli_database.test.name}"
  privileges = ["%s"]
}
...
func TestAccResourceDliAuth_flink(t *testing.T) {
	...
	resource.ParallelTest(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			{
				Config: testAccDliAuthResource_flink(name, acceptance.HCSO_PROJECT_ID, acceptance.HCSO_REGION_NAME, "GET"),
				Check: resource.ComposeTestCheckFunc(
					rc.CheckResourceExists(),
					resource.TestCheckResourceAttr(resourceName, "user_name", name),
			...
			{
				Config: testAccDliAuthResource_flink(name, acceptance.HCSO_PROJECT_ID, acceptance.HCSO_REGION_NAME, "START"),
				Check: resource.ComposeTestCheckFunc(
					rc.CheckResourceExists(),
					resource.TestCheckResourceAttr(resourceName, "user_name", name),
					resource.TestMatchResourceAttr(resourceName, "object", regexp.MustCompile(`jobs\.flink\.\d*`)),
...
resource "hcso_dli_permission" "test" {
  user_name  = hcso_identity_user.test.name
  object     = "jobs.flink.${hcso_dli_flinksql_job.test.id}"
  privileges = ["%s"]
}
...
func TestAccResourceDliAuth_table(t *testing.T) {
	...
	resource.ParallelTest(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			{
				Config: testAccDliAuthResource_table(name, acceptance.HCSO_PROJECT_ID, "SELECT"),
				Check: resource.ComposeTestCheckFunc(
					rc.CheckResourceExists(),
					resource.TestCheckResourceAttr(resourceName, "user_name", name),
			...
			{
				Config: testAccDliAuthResource_table(name, acceptance.HCSO_PROJECT_ID, "DROP_TABLE"),
				Check: resource.ComposeTestCheckFunc(
					rc.CheckResourceExists(),
					resource.TestCheckResourceAttr(resourceName, "user_name", name),
					resource.TestCheckResourceAttr(resourceName, "object",
...
resource "hcso_dli_permission" "test" {
  user_name  = hcso_identity_user.test.name
  object     = "databases.${hcso_dli_database.test.name}.tables.${hcso_dli_table.test.name}"
  privileges = ["%s"]
}
...
func TestAccResourceDliAuth_package(t *testing.T) {
	...
	resource.ParallelTest(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			{
				Config: testAccDliAuthResource_package(name, acceptance.HCSO_PROJECT_ID, packageGroupName, "USE_GROUP"),
				Check: resource.ComposeTestCheckFunc(
					rc.CheckResourceExists(),
					resource.TestCheckResourceAttr(resourceName, "user_name", name),
			...
			{
				Config: testAccDliAuthResource_package(name, acceptance.HCSO_PROJECT_ID, packageGroupName, "GET_GROUP"),
				Check: resource.ComposeTestCheckFunc(
					rc.CheckResourceExists(),
					resource.TestCheckResourceAttr(resourceName, "user_name", name),
					resource.TestCheckResourceAttr(resourceName, "object", fmt.Sprintf("groups.%s", packageGroupName)),
...
resource "hcso_dli_permission" "test" {
  user_name  = hcso_identity_user.test.name
  object     = "groups.${hcso_dli_package.test.group_name}"
  privileges = ["%s"]
}
...
func TestAccResourceDliAuth_queue(t *testing.T) {
	...
	resource.ParallelTest(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			{
				Config: testAccDliAuthResource_queue(name, acceptance.HCSO_PROJECT_ID, "DROP_QUEUE"),
				Check: resource.ComposeTestCheckFunc(
					rc.CheckResourceExists(),
					resource.TestCheckResourceAttr(resourceName, "user_name", name),
			...
			{
				Config: testAccDliAuthResource_queue(name, acceptance.HCSO_PROJECT_ID, "SUBMIT_JOB"),
				Check: resource.ComposeTestCheckFunc(
					rc.CheckResourceExists(),
					resource.TestCheckResourceAttr(resourceName, "user_name", name),
					resource.TestCheckResourceAttr(resourceName, "object", fmt.Sprintf("queues.%s", name)),
...
resource "hcso_dli_permission" "test" {
  user_name  = hcso_identity_user.test.name
  object     = "queues.${hcso_dli_queue.test.name}"
  privileges = ["%s"]
}
...
resource "hcso_identity_role" "role_1" {
  name        = "%s"
...
resource "hcso_identity_role_assignment" "role_assignment_1" {
  role_id    = hcso_identity_role.role_1.id
