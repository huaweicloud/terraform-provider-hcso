...
func TestAccDatasourceAuth_basic(t *testing.T) {
	...
	rName := "hcso_dli_datasource_auth.test"
...
`, name, acceptance.HCSO_DLI_DS_AUTH_CSS_OBS_PATH)
}
...
`, name, acceptance.HCSO_DLI_DS_AUTH_KAFKA_TRUST_OBS_PATH, acceptance.HCSO_DLI_DS_AUTH_KAFKA_KEY_OBS_PATH)
}
...
`, name, acceptance.HCSO_DLI_DS_AUTH_KRB_CONF_OBS_PATH, acceptance.HCSO_DLI_DS_AUTH_KRB_TAB_OBS_PATH)
}
