...
func TestAccDatasourceInstances_basic(t *testing.T) {
	rName := "data.hcso_cnad_advanced_instances.test"
...
data "hcso_cnad_advanced_instances" "instance_id_filter" {
  instance_id = data.hcso_cnad_advanced_instances.test.instances.0.instance_id
}
output "instance_id_filter_is_useful" {
  value = alltrue([for v in data.hcso_cnad_advanced_instances.instance_id_filter.instances[*].instance_id :
  v == data.hcso_cnad_advanced_instances.test.instances.0.instance_id])
}

data "hcso_cnad_advanced_instances" "instance_name_filter" {
  instance_name = data.hcso_cnad_advanced_instances.test.instances.0.instance_name
}
output "instance_name_filter_is_useful" {
  value = alltrue([for v in data.hcso_cnad_advanced_instances.instance_name_filter.instances[*].instance_name :
  v == data.hcso_cnad_advanced_instances.test.instances.0.instance_name])
}

data "hcso_cnad_advanced_instances" "instance_type_filter" {
  instance_type = data.hcso_cnad_advanced_instances.test.instances.0.instance_type
}
output "instance_type_filter_is_useful" {
  value = alltrue([for v in data.hcso_cnad_advanced_instances.instance_type_filter.instances[*].instance_type :
  v == data.hcso_cnad_advanced_instances.test.instances.0.instance_type])
}

data "hcso_cnad_advanced_instances" "region_filter" {
  region = data.hcso_cnad_advanced_instances.test.instances.0.region
}
output "region_filter_is_useful" {
  value = alltrue([for v in data.hcso_cnad_advanced_instances.region_filter.instances[*].region :
  v == data.hcso_cnad_advanced_instances.test.instances.0.region])
}
`
}
