...
func TestAccPolicy_basic(t *testing.T) {
	var (
		...
		resourceName = "hcso_cbr_policy.test"
	)
		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					resource.TestCheckResourceAttr(resourceName, "destination_region", acceptance.HCSO_DEST_REGION),
					resource.TestCheckResourceAttr(resourceName, "destination_project_id", acceptance.HCSO_DEST_PROJECT_ID),
					resource.TestCheckResourceAttr(resourceName, "time_period", "20"),
