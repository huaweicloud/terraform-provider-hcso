...
func TestAccASInstanceAttach_basic(t *testing.T) {
	...
	rName := "hcso_as_instance_attach.test0"
		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					resource.TestCheckResourceAttrPair(rName, "scaling_group_id", "hcso_as_group.acc_as_group", "id"),
					resource.TestCheckResourceAttrPair(rName, "instance_id", "hcso_compute_instance.test.0", "id"),
...
resource "hcso_as_instance_attach" "test0" {
...
resource "hcso_as_instance_attach" "test1" {
  scaling_group_id = hcso_as_group.acc_as_group.id
