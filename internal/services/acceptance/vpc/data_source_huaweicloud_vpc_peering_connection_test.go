...
func TestAccVpcPeeringConnectionDataSource_basic(t *testing.T) {
	...
	dataSourceName := "data.hcso_vpc_peering_connection.test"
...
data "hcso_vpc_peering_connection" "test" {
  id = hcso_vpc_peering_connection.test.id
}
...
data "hcso_vpc_peering_connection" "test" {
	vpc_id = hcso_vpc_peering_connection.test.vpc_id
}
`, testAccVpcPeeringConnectionDataSource_base(rName))
}
...
data "hcso_vpc_peering_connection" "test" {
	peer_vpc_id = hcso_vpc_peering_connection.test.peer_vpc_id
}
`, testAccVpcPeeringConnectionDataSource_base(rName))
}
