...
Provides a VPC subnet resource withinHuawei Cloud Stack Online.
...
* `ntp_server_address` - (Optional, String) Specifies the NTP server address. Currently only IPv4 addresses are
  supported.
