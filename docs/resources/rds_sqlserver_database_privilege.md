...
Manages RDS SQL Server database privilege resource within Huawei Cloud Open Stack.
...
```bash
$ terraform import hcso_rds_sqlserver_database_privilege.test <instance_id>/<db_name>
```
