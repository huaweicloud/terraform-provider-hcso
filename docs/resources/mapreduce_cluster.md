...
Manages a cluster resource within Huawei Cloud Stack Online MRS.
...
* `version` - (Required, String, ForceNew) Specifies the MapReduce cluster version. The valid values are `MRS 3.1.5`
