...
Manages RDS PostgreSQL account resource within Huawei Cloud Open Stack.
...
resource "hcso_rds_pg_account" "test" {
...
```bash
$ terraform import hcso_rds_pg_account.test <instance_id>/<name>
```
...
```hcl
resource "hcso_rds_pg_account" "account_1" {
    ...
